            ...
            while((line = reader.readLine()) != null){
                ...
                if (lineArray[0].equals("FullTimeEmployee")){
                    ...
                    */
                    ...
                    FullTimeEmployee employee = new FullTimeEmployee(  Integer.valueOf(lineArray[2]), 
                                                                       (lineArray[3]), 
                                                                       (lineArray[4]),
                                                                       Integer.valueOf(lineArray[5]), 
                                                                       Integer.valueOf(lineArray[6]), 
                                                                       Double.valueOf(lineArray[7]), 
                    ...
                    */
                    ...
                    PartTimeEmployee employee = new PartTimeEmployee(   Integer.valueOf(lineArray[4]),
                                                                        (lineArray[5]),
                                                                        (lineArray[6]),
                                                                        Integer.valueOf(lineArray[7]),
                                                                        Integer.valueOf(lineArray[8]),
                                                                        Double.valueOf(lineArray[9]),
                                                                        Double.valueOf(lineArray[1]),
                    ...
                    for (int x = 0; x < buckets[i].size(); x++)
                    {
                        ...
                        else if (employee instanceof PartTimeEmployee)
                        {
                            ...
                            */
                            ...
                            PartTimeEmployee emp = (PartTimeEmployee) buckets[i].get(x);
